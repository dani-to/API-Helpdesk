...
class TICKET extends CONEXION{
    ...
    public function queryconsultaTicketDatos($folio){
        //Modificado
        $query="SELECT  tk.id_cliente, tk.id_incidente, tk.id_venta, tk.descripcion, tk.imagen, tk.estatus,  ic.id_incidente, ic.nivel_prioridad, ic.tipo_problema FROM tickets tk, incidentes ic WHERE tk.id_incidente = ic.id_incidente";
        $this->connect();
        $resultado = $this->getData($query);
        $this->close();
        return $resultado;
